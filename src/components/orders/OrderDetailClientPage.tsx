    ...
    const invoiceHTML = `
      ...
      <body>
        <div class="header">
          <h1>${t.shopName}</h1>
          <p>${effectiveLang === 'ar' ?
            (order.transactionType === 'Rental' ? 'فاتورة إيجار' : 'فاتورة بيع') :
        ...
        <div class="divider"></div>
        <div class="section">
          <h3>${effectiveLang === 'ar' ? 'ملاحظات هامة:' : 'Important Notes:'}</h3>
          <div class="notes">
            ${effectiveLang === 'ar' ?
              `<div class="note-item">1- استلام بالبطاقة الشخصية للمستلم نفسه</div>
<div class="note-item">2- الإمضاء على الإيصال في حالة عدم ترك البطاقة</div>
<div class="note-item">3- لا يسترد العربون بعد الحجز</div>
<div class="note-item">4- التسليم من 1 - 4</div>
<div class="note-item">5- الاستلام من 4 - 9</div>` :
              `<div class="note-item">1- Receipt with personal ID of the recipient</div>
<div class="note-item">2- Sign the receipt in the "do not leave ID" section</div>
<div class="note-item">3- Deposit is non-refundable after booking</div>
<div class="note-item">4- Delivery from 1 - 4</div>
<div class="note-item">5- Pickup from 5 - 10</div>`
            }
          </div>
        </div>
